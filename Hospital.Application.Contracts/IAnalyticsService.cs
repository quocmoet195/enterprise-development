...
public interface IAnalyticsService
{
    ...
    IEnumerable<DoctorDto> GetDoctorsWith10Plus();
    ...
    IEnumerable<string> GetPatientNamesForDoctor(int doctorId);
    ...
    int GetFollowUpsLastMonth(DateTime now);
    ...
    IEnumerable<PatientDto> GetPatients30PlusMultiDoctors(DateOnly today);
    ...
    IEnumerable<AppointmentDto> GetThisMonthInRoom(string room, DateTime now);
}
